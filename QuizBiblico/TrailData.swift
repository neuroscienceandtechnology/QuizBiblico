    ...
    static let nodes: [TrailNodeData] = [
        ...
        TrailNodeData(
            ...
            questions: [
                ...
                TrailQuestion(id: 505, question: "O que Deus providenciou no lugar de Isaque no sacrifício?", options: ["Uma pomba", "Um bezerro", "Um cordeiro", "Um carneiro"], correctIndex: 3, explanation: "Abraão ergueu os olhos e viu um carneiro preso pelos chifres num matagal, e o ofereceu como holocausto (Gênesis 22:13)."),
            ],
            status: .locked
        ),
        ...
        TrailNodeData(
            ...
            questions: [
                ...
                TrailQuestion(id: 1204, question: "Quantos dias os israelitas marcharam ao redor de Jericó?", options: ["3 dias", "5 dias", "7 dias", "40 dias"], correctIndex: 2, explanation: "Eles marcharam ao redor da cidade uma vez por dia durante seis dias, e no sétimo dia marcharam sete vezes (Josué 6:14-15)."),
